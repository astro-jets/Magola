        ...
        <div className="bg-neutral-900">
            <div className="max-w-5xl px-4 xl:px-0 py-10 lg:py-20 mx-auto">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-x-10 lg:gap-x-16">
                  ...
                  [&amp;:not(:placeholder-shown)]:pb-2
                  autofill:pt-6
                  autofill:pb-2" placeholder="This is a textarea placeholder" style={{ "height": "75px" }}></textarea>
                            ...
                            <div className="mt-2">
                                ...
                                <p className="mt-5">
                                    <a className="group inline-flex items-center gap-x-2 py-2 px-3 bg-primary font-medium text-sm text-neutral-800 rounded-full focus:outline-none" href="#">
                                        Submit
                                        <svg className="shrink-0 size-4 transition group-hover:translate-x-0.5" xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
                    ...
                    <div className="space-y-14">
                        ...
                        <div className="flex gap-x-5">
                            ...
                            <div className="grow">
                                ...
                                <p className="mt-2">
                                    <a className="group inline-flex items-center gap-x-2 font-medium text-sm text-primary decoration-2 hover:underline focus:outline-none focus:underline" href="#">
                                        Job openings
