                            ...
                            <form action={handleSubmit} className="space-y-4">
                                ...
                                <div className="flex flex-wrap items-center justify-between gap-4">
                                    <div className="flex items-center">
                                        <input id="remember-me" name="remember-me" type="checkbox" className="h-4 w-4 shrink-0 text-primary focus:ring-orange-500 border-gray-300 rounded" />
                                ...
                                <p className="text-sm !mt-8 text-center text-gray-800">
                                    ...
                                    <Link href="/signup" className="text-primary font-semibold hover:underline ml-1 whitespace-nowrap">
                                        Register here
                                    </Link>
                                </p>
                            </form>
